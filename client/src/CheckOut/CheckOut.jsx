...
function CheckOut() {
  ...
  const shippingInformation = () => (
    ...
    <div className="checkout-contactShippingContainer">
      <div className="checkout-contactShippingLock">
        ...
        <div id="checkout-offersContainer">
      ...
      <form className="checkout-contactForm">
        <span id="checkout-shippingInformation">Shipping Address</span>
        ...
        <div className="checkout-selectOptions">
        ...
        <div className="checkout-shippingButtons">
          <button
            type="button"
          ...
          <button type="submit" aria-label="Continue to Payment" onClick={() => { setPage('payment'); }}>Continue to Payment</button>
        </div>
      </form>
    </div>
  );
    ...
    <div className="checkout-paymentInfo">
      <form className="checkout-paymentForm">
        ...
        <div className="checkout-finalButtons">
          ...
          <form id="checkout-placeOrder" action="https://youtu.be/dQw4w9WgXcQ">
